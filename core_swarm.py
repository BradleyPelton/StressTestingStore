...
class UserBehaviour(TaskSet):
    # IT IS a best practice to add timeouts to every request.
    # TODO- refactor all requests to have timeouts 
    def setup(self):
    ...
    def on_start(self):
        ...
        self.uuid = str(uuid.uuid1())  # UUID to be used multiple places as a payload item
